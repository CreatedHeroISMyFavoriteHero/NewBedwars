...
local Combat = GuiLibrary.CreateWindow("Combat", "rent/assets/CombatIcon.png", 15, UDim2.new(0, 223, 0, 6), false)
local Blatant = GuiLibrary.CreateWindow("Blatant", "rent/assets/BlatantIcon.png", 16, UDim2.new(0, 223, 0, 6), false)
...
GUI.CreateButton("Blatant", function() Blatant.SetVisible(true) end, function() Blatant.SetVisible(false) end, "rent/assets/BlatantIcon.png", 16)
GUI.CreateButton("Render", function() Render.SetVisible(true) end, function() Render.SetVisible(false) end, "rent/assets/RenderIcon.png", 17)
...
local TargetInfo = GuiLibrary.CreateCustomWindow("Target Info", "rent/assets/TargetInfoIcon1.png", 16, UDim2.new(0, 177, 0, 6), false)
...
GUI.CreateCustomToggle("Target Info", "rent/assets/TargetInfoIcon2.png", function() TargetInfo.SetVisible(true) end, function() TargetInfo.SetVisible(false) end, false, "OptionsButton", 1)
