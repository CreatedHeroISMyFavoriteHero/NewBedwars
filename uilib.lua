...
api["CreateMainWindow"] = function()
	...
	windowlogo1.Image = getcustomassetfunc("rent/assets/vapeLogo1.png")
	...
	discordbutton.MouseButton1Click:connect(function()
		...
		spawn(function()
			local hover3textsize = game:GetService("TextService"):GetTextSize("My Discord ID is set to your clipboard", 16, Enum.Font.SourceSans, Vector2.new(99999, 99999))
			...
			hoverbox3.Text = "My Discord ID is set to your clipboard"
			hoverbox3.ZIndex = 5
...
api["LoadedAnimation"] = function(enabled)
	if enabled then
		...
		api["CreateNotification"]("Finished Loading, this was coded by rent#8392", "Press "..string.upper(api["GUIKeybind"]).." to open GUI", 4)
		spawn(function()
			pcall(function()
				wait(2.5)
